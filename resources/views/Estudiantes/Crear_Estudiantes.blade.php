...
<div class="row mt-5">
  <div class="d-flex justify-content-center">
    <form class="mt-3 w-75 needs-validation" novalidate method="post" action="{{route('Estudiantes.store');}}">
    @csrf
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input name="Fecha_Nacimiento" type="date" class="form-control" id="FechadeNacimiento">
      </div>
    <div class="mb-3">
